...
<div class="singleview_container">
			<div class="logo singleview">
                <a href="https://claralund.dk/kea/10_eksamen/bogino/" class="logo_desktop"><img src= "<?php echo get_stylesheet_directory_uri() ?>/assets/bogino_logo_v2.svg" alt=""></a>
                <a href="https://claralund.dk/kea/10_eksamen/bogino/" class="logo_mobile"><img src= "<?php echo get_stylesheet_directory_uri() ?>/assets/bogino_logo_mobile.svg" alt=""></a>
            </div>
		...
		<script>
			/** @format */
			const url = "https://claralund.dk/kea/10_eksamen/bogino/wp-json/wp/v2/produkt/" + <?php echo get_the_ID() ?>;
			const colourUrl = "https://claralund.dk/kea/10_eksamen/bogino/wp-json/wp/v2/produkt/" + <?php echo get_the_ID() ?>;
